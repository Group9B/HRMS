                ...
                <div class="card stat-card shadow-sm">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= count(array_filter($teams, function($team) { return strtotime($team['created_at']) > strtotime('-7 days'); })) ?></div>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card border-left-primary shadow-sm h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="#" onclick="viewTeam(<?= $team['id'] ?>)">
                                                        <i class="fas fa-eye me-2"></i>View Details
                                                    </a></li>
                                                    <li><a class="dropdown-item" href="#" onclick="editTeam(<?= $team['id'] ?>)">
                                                        <i class="fas fa-edit me-2"></i>Edit Team
                                                    </a></li>
                                                    <li><a class="dropdown-item" href="#" onclick="manageMembers(<?= $team['id'] ?>)">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <button class="btn btn-sm btn-outline-success" onclick="manageMembers(<?= $team['id'] ?>)">
                                                <i class="fas fa-user-plus me-1"></i>Members
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            <form id="createTeamForm">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="team_description" name="description" rows="3" placeholder="Describe the team's purpose and objectives..."></textarea>
                    </div>
                </div>
