...
if (!$empRes['success'] || empty($empRes['data'])) { redirect('/hrms/unauthorized.php'); }
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="table-responsive mobile-table-scroll">
                    <table class="table table-hover table-sm align-middle nowrap" id="attendanceTable" style="width:100%">
                        ...
                        <?php foreach ($rows as $r): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge text-bg-<?= $r['status']==='present'?'success':($r['status']==='absent'?'danger':($r['status']==='leave'?'warning':'info')) ?>">
                                        <?= ucfirst($r['status']) ?>
                                    </span>
                                </td>
                            </tr>
