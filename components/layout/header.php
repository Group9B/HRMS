            ...
            <div class="wrapper d-flex align-items-center justify-content-end gap-3">
                <?php if (isLoggedIn()): ?>
                    <div class="notifications position-relative">
                        <div class="dropdown">
                            <button class="btn dropdown-toggle position-relative" type="button" id="notificationButton"
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow-lg" aria-labelledby="notificationButton"
                                ...
                                <li class="text-center">
                                    <a class="dropdown-item small text-primary" href="/hrms/employee/notifications.php">View all
                                        notifications</a>
                                </li>
                            </ul>
                        </div>
