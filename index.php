    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top shadow-sm py-3">
        <div class="container">
            ...
            <button class="navbar-toggler border-0 shadow-none z-3" type="button" data-bs-toggle="offcanvas"
                ...
                <i class="fas fa-bars fa-lg" id="navbarTogglerIcon"></i>
            </button>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="position-relative p-4 bg-light rounded-4 border" data-aos="fade-left"
                        ...
                        <div
                            ...
                            <i class="fas fa-chart-line me-1"></i> +24% Productivity
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row align-items-center g-5">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <a href="#" class="btn btn-outline-primary rounded-pill fw-semibold px-4">See Analytics Features</a>
                </div>
                <div class="col-lg-6" data-aos="fade-left">
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    ...
                    <div class="position-relative p-2 bg-white rounded-4 border border-secondary">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle text-center p-3 w-100"
                            ...
                            <div class="mb-3"><i class="fas fa-file-invoice-dollar fa-3x text-primary"></i></div>
    ...
    <section class="py-5 bg-primary bg-gradient text-white">
        <div class="container py-5 text-center">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-center gap-3">
                <a href="#" class="btn btn-light btn-lg px-4 px-md-5 rounded-pill fw-bold text-primary shadow-sm">Get
                    Started Now</a>
                <a href="#" class="btn btn-outline-light btn-lg px-4 px-md-5 rounded-pill fw-semibold">Contact Sales</a>
            </div>
        </div>
    </section>
